...
- [x] 9.1 — Implement dark mode (Tailwind dark: prefix, localStorage toggle, dashboard toggle button)
- [x] 9.2 — Add skeleton loaders to all data-fetching pages
- [x] 9.3 — Add empty states to all list/table pages
- [x] 9.4 — Add toast notifications (sonner) for all success/error actions
- [x] 9.5 — Audit all forms for zod validation and react-hook-form integration
- [x] 9.6 — Audit all API routes for proper HTTP status codes and try/catch
- [x] 9.7 — Add JSDoc comments to all lib/ functions
- [x] 9.8 — Final UI review against design standards (typography, spacing, color system)
- [x] 9.9 — Verify no hardcoded secrets — all env vars referenced from process.env
- [x] 9.10 — Write vercel.json / deployment config and confirm Vercel-ready build
